...
public class NfcService implements DeviceHostListener {
    ...
    static final int TASK_RESTART = 4; // [SEC] SIM detection
    ...
    private boolean mIsShutdown = false; // [SEC]
    ...
    public void onEeUpdated() {
        /* [SEC] Don't execute applyRouting
         * to prevernt unexpected commit routing */
    ...
    void updatePackageCache() {
        ...
        synchronized (this) {
            ...
            for (int i = 0; i < packagesNfcEvents.size(); i++) {
                // [SEC] Check permissions. TS.27 requirements
                if (pm.checkPermission(android.Manifest.permission.NFC,
                                       packagesNfcEvents.get(i).packageName) == PackageManager.PERMISSION_GRANTED) {
                    Log.d(TAG, "updatePackageCache ADD: " + packagesNfcEvents.get(i).packageName);
    ...
    class EnableDisableTask extends AsyncTask<Integer, Void, Void> {
        ...
        boolean disableInternal() {
            ...
            // Avoid watchdog and NCI command timeout during the disable nfc
            mDeviceHost.doSetRfEnabled(false);
    ...
    private NfcDiscoveryParameters computeDiscoveryParameters(int screenState) {
        ...
        /* [SEC] Do not disable RF discovery regardless of Screen state
         * [AOSP] if (mIsHceCapable && mScreenState >= ScreenStateHelper.SCREEN_STATE_ON_LOCKED && mReaderModeParams == null) {
         */
    ...
    final class NfcServiceHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            // [SEC] Ignore message when shutting down
            if (mIsShutdown) {
                Log.d(TAG, "device shutting down. ignore messages");
                return;
            }
            switch (msg.what) {
                case MSG_ROUTE_AID: {
